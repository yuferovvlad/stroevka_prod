...
urlpatterns = [
                  ...
                  path(r'create_fields/', CreateFields.as_view(), name='create_fields'),
                  path(r'create_fields_sign/', CreateFieldsSign.as_view(), name='create_fields_sign'),

                  path(r'list_users/', views.list_users, name='list_users_url'),
                  path(r'list_users_sign/', views.list_users_sign, name='list_users_sign_url'),

                  path(r'list_users/<int:pk>/edit/',
                       UsersUpdate.as_view(), name='list_users_edit_url'),
                  path(r'list_users_sign/<int:pk>/edit/',
                       UsersSignUpdate.as_view(), name='list_users_sign_edit_url'),

                  path(r'list_users/<int:pk>/delete/',
                       UsersDelete.as_view(), name='users_delete_url'),
                  path(r'list_users_sign/<int:pk>/delete/',
                       UsersSignDelete.as_view(), name='users_sign_delete_url'),
